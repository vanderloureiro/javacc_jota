/* Generated By:JavaCC: Do not edit this line. JotaTokenManager.java */
import java.io.*;

/** Token Manager. */
public class JotaTokenManager implements JotaConstants
{
...
private static final int jjStopStringLiteralDfa_0(int pos, long active0)
{
   switch (pos)
   {
      ...
      case 2:
         ...
         return -1;
      case 3:
         if ((active0 & 0x4280300L) != 0L)
            return 2;
         if ((active0 & 0x8058440ce0L) != 0L)
         {
            jjmatchedKind = 41;
            jjmatchedPos = 3;
            return 2;
         ...
         return -1;
      case 4:
         if ((active0 & 0x8400040L) != 0L)
            return 2;
         if ((active0 & 0x8050040ca0L) != 0L)
         {
            jjmatchedKind = 41;
            jjmatchedPos = 4;
            return 2;
...
static private int jjMoveStringLiteralDfa1_0(long active0)
{
   ...
   switch(curChar)
   {
      ...
      case 101:
         return jjMoveStringLiteralDfa2_0(active0, 0x8000140000L);
      case 102:
         if ((active0 & 0x2000000L) != 0L)
...
static private int jjMoveStringLiteralDfa2_0(long old0, long active0)
{
   ...
   switch(curChar)
   {
      ...
      case 105:
         return jjMoveStringLiteralDfa3_0(active0, 0x8080300L);
      case 108:
...
static private int jjMoveStringLiteralDfa3_0(long old0, long active0)
{
   ...
   switch(curChar)
   {
      ...
      case 108:
         return jjMoveStringLiteralDfa4_0(active0, 0x18000020L);
      case 110:
...
"\123\164\162\151\156\147", "\145\170\164\145\156\144\163", "\133", "\135", "\173", "\175", "\50", "\51", 
"\162\145\164\165\162\156", "\164\150\151\163", "\156\145\167", "\164\162\165\145", 
"\146\141\154\163\145", "\41", "\46\46", "\151\146", "\145\154\163\145", "\167\150\151\154\145", 
"\142\157\157\154\145\141\156", "\151\156\164", 
"\123\171\163\164\145\155\56\157\165\164\56\160\162\151\156\164\154\156", "\75", "\74", "\53", "\55", "\52", "\73", "\54", "\56", 
...
/** Constructor. */
public JotaTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public JotaTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
